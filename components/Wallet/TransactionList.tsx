...
export const TransactionList: React.FC<TransactionListProps> = ({ 
  ...
  const renderTransactionItem = ({ item }: { item: FlintopWalletTransaction }) => (
    <View style={styles.transactionItem}>
      ...
      <View style={styles.amountContainer}>
        ...
        >
          {getAmountPrefix(item.type)}{currency}{Math.abs(item.amount).toFixed(2)}
        </Text>
        <Text style={styles.balanceAfter}>
          Balance: {currency}{item.balance.toFixed(2)}
        </Text>
      </View>
    </View>
  );
  ...
  const renderEmptyState = () => (
    <View style={styles.emptyState}>
      ...
      <Text style={styles.emptyStateText}>
        Your wallet transactions will appear here once you start using your balance.
      </Text>
    </View>
  );
